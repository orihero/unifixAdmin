...
module.exports = {
    ...
    /* 08.0.Custom */
    "menu.data": "Данные",
    "menu.dashboards": "Приборная доска",
    ...
    "menu.shops": "Магазини",
    "menu.all-shops": "Все магазини",
    "menu.couriers": "Курьеры",
    "menu.factories": "Заводы",
    "menu.admins": "Админы",
    "menu.orders": "Заказы",
    "menu.stocks": "Cклады",
    "menu.all-orders": "Все заказы",
    "menu.all-stocks": "Все cклады",
    "menu.app": "Главная",
    "menu.categories": "Категории",

    "modal.legal-name": "legal-name"
};
