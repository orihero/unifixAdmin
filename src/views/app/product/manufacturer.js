...
import { IMAGE_UPLOAD, LIST_CATEGORIES_NESTED, LIST_MY_ADMIN_MANUFACTURER, UPDATE_MANUFACTURER, ADD_MANUFACTURER, REMOVE_MANUFACTURER } from '../../../graphql/requests';
import ManufacturerItem from '../../../containers/pages/ManufacturerItem';


export default withDataHOC(ManufacturerItem,
    {
        fetchQuery: LIST_MY_ADMIN_MANUFACTURER,
